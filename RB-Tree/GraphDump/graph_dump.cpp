...
int GenerateGraph(RBTree *Node, char* buffer, int* buffer_len, const size_t BUFFER_SIZE)
{
    ...
    *buffer_len += snprintf(buffer + *buffer_len, BUFFER_SIZE - (size_t)*buffer_len,
                        ...
                        "\t\t\t           <tr><td align='center' colspan='2' BGCOLOR='%s'><FONT COLOR='#ffffff'><b>Node: %p</b></FONT></td></tr>\n"
                        "\t\t\t           <tr><td align='center' colspan='2'><FONT COLOR='#4d3d03'>Value: <b>%03d</b></FONT></td></tr>\n"
                        "\t\t\t           <tr><td align='center' colspan='2'><FONT COLOR='%s'>Color: <b>%s</b></FONT></td></tr>\n"
                        "\t\t\t           <tr><td align='center' colspan='2'><FONT COLOR='#3a3a3a'>Parent: <b>%p</b></FONT></td></tr>\n"
                        "\t\t\t           <tr>\n"
                        "\t\t\t               <td WIDTH='150' PORT='left'  align='center'><FONT COLOR='#006400'><b>Left: %p</b></FONT></td>\n"
                        "\t\t\t               <td WIDTH='150' PORT='right' align='center'><FONT COLOR='#ba6504'><b>Right: %p</b></FONT></td>\n"
                        "\t\t\t           </tr>\n"
                        "\t\t         </table> >];\n",
                        Node,
    ...
    if (Node->right)
    {
        ...
        *buffer_len += snprintf(buffer + *buffer_len, BUFFER_SIZE - (size_t)*buffer_len,
                                "\t node%p:right -> node%p [color=\"#ba6504\"style=bold; weight=1000; ];\n", Node, Node->right);
    }
